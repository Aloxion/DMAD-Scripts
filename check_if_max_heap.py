# Function to check if the given list represents max-heap or not
def checkMaxHeap(A, i):
    ...
    left = (A[i] >= A[2*i + 1]) and checkMaxHeap(A, 2*i + 1)
...
if __name__ == '__main__':
    ...
    if checkMaxHeap(A, index):
        print('The given list is a max-heap')
    else:
        print('The given list is not a max-heap')
